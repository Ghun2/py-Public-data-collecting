...
def mdb_insert_one(res,bjdcd):
    ...
    sql = 'INSERT INTO IndvdLandPriceService (%s) VALUES (%s);' % (keystr,var_string)
    # print(sql)
...
def rest_call(BJD_code):
    ...
    params = 'pnu=' + BJD_code + '&numOfRows=1&serviceKey='+ curr_key
...
#call_key00 = '10c32e9e3a4e2cceca2554'
key_container = []
...
for j in range(5569,5600):   #index 287 divide 7 이제 8하면됨
    plc = totplc[j]
    BJD_code = str(plc[0])
